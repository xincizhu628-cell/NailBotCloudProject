...
def ensure_admin_schema(connection):
    ...
    add_column_if_missing(connection, "events", "html_url", "TEXT")
    add_column_if_missing(connection, "tasks", "promo_asset_id", "INTEGER")
    add_column_if_missing(connection, "orders", "print_code", "TEXT")
    add_column_if_missing(connection, "orders", "pickup_code", "TEXT NOT NULL DEFAULT '000000'")
    ...
    add_column_if_missing(connection, "assets", "sha256", "TEXT")
    connection.execute("CREATE UNIQUE INDEX IF NOT EXISTS idx_assets_sha256 ON assets(sha256) WHERE sha256 IS NOT NULL AND sha256 != ''")
    ...
    add_column_if_missing(connection, "products", "bound_device_id", "TEXT")
    ...
    add_column_if_missing(connection, "rewards", "bound_device_id", "TEXT")
